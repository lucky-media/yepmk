...
<div class="container mt-40 mb-48">
    <div class="row mt-24">
        <div class="col-12 md:col-5 lg:col-5">
            ...
            <p class="my-6 font-medium text-base">Our long-term goals mainly include:</p>
        ...
        <div class="col-12 mt-20 md:mt-0 md:col-6 md:offset-1">
            ...
            <p class="my-6 font-medium text-base text-justify">YEP has been active for four years, and
                ...
                <br>Not only are these events a way for members to develop their skills and knowledge, but they also serve
